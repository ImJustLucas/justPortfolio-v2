...
const projects: ProjectType[] = [
  ...
  },
  {
    ...
    role: 'Founder',
    description:
      'DAILY.YOU are an app designed for daily journaling. Every day/week you have to write down three good things that happened to you + one habit that you could do better to improve in the future. And it only takes 5m per day.',
  },
  {
    header: {
